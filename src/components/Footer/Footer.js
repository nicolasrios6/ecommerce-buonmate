    ...
    return(
        <div className='footer'>
            ...
            <ul className='footer__socialMedia'>
                <li><a href='https://api.whatsapp.com/send/?phone=5492613031702&text&type=phone_number&app_absent=0'><WhatsAppIcon className='socialMedia__icons' /></a></li>
                <li><a href='https://www.facebook.com/buon.mate.7'><FacebookIcon className='socialMedia__icons' /></a></li>
                <li><a href='https://www.instagram.com/buon.mate/'><InstagramIcon className='socialMedia__icons' /></a></li>
            </ul>
